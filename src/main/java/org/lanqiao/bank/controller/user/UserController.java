...
public class UserController {
	 ...
	 * @time 2017年6月23日 下午7:26:12 void
	 */
	...
	public ModelAndView registB(User user, @RequestParam("file") MultipartFile file, HttpServletRequest request) {
		...
		try {
			...
			if (r == 1) {
				...
				String resetPassHref = "http://www.husuli.pw/ibank/LUser/User/registe_d";
				String emailContent = "请勿回复本邮件.点击下面的链接,完成注册<br/><a href=" + resetPassHref
						+ " target='_BLANK'>点击我完成注册</a>";
	...
	public String updatePassword(Integer id, String password, String password1, String password2,
