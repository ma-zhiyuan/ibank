			...
			<div class="glb-main">
				...
				<div class="glb-main-bd">
					<div class="glb-main-content">
						<form id="form" name="form" class="form-inline" action="${basepath }/LCustomer/CustomerAndUser/userRepayment" style="">
							<div style="padding-left: 100px;">
							<span style="color: red">该用户已还款${sessionScope.totalMonth }期，剩余需还${sessionScope.surplusMonth}期。</span>
							<div class="form-item">
									<h5>
										<input class="form-control" type="hidden" id="id" name="id"
											value="${sessionScope.loan.id }" readonly />
									</h5>
								</div>
								<div class="form-item">
									<h5>
										贷款日期:<input class="form-control" type="text"
											value="${sessionScope.loan.createTime }" readonly />
									</h5>
								</div>
								<div class="form-item">
									<h5>
										贷款金额:<input class="form-control" type="text"
											value="${sessionScope.loan.loanMoney }" readonly />
									</h5>
								</div>
								<div class="form-item">
									<h5>
										贷款利率:<input class="form-control" type="text"
											value="${sessionScope.loan.interest.rate}" readonly />
									</h5>
								</div>
								<div class="form-item">
									<h5>
										总计需还:<input class="form-control" type="text"
											value="${sessionScope.totalRepaymentMoney}" readonly />
									</h5>
								</div>
								<div class="form-item">
									<h5>
										仍需要还:<input class="form-control" type="text"
											value="${sessionScope.repaymentMoney}" readonly />
									</h5>
								</div>
								<div class="form-item">
									<h5>
										还款方式:<input class="form-control" type="text"
											value="${sessionScope.str1 }" readonly />
									</h5>
								</div>
								<div class="form-item">
									<h5>
										还款期数:<input class="form-control" type="number" name="month"
