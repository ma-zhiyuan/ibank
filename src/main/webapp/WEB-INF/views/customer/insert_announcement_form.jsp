...
<body>
	...
	<div id="header">
		<div class="layout">
			<div id="logo">
				<a href="uc.html"> <img src="${basepath}/resources/admin/images/logo_w.png" alt="蓝桥" />
				</a>
			</div>
			<div id="nav" class="glb-nav">
				<ul class="clearfix">
					<li class="glb-nav-trade"><a href="${basepath }/LCustomer/customer/customerAnnouncement?pageNow=1"
						style="color: black;text-decoration: none;font-size: 16px;"> <span>最新通知</span>
					</a></li>
					<c:if test="${empty announcement }">
						<li class="glb-nav-uc current"><a href="${basepath }/LCustomer/customer/toInsertForm"
							style="color: black;text-decoration: none;font-size: 16px;"> <span>新增通知</span>
						</a></li>
					</c:if>
					<c:if test="${!empty announcement }">
						<li class="glb-nav-uc current"><a href="#"
							style="color: black;text-decoration: none;font-size: 16px;"> <span>更新通知</span>
						</a></li>
					</c:if>
			...
			<div class="more2">
				...
				<c:if test="${empty announcement }">
					<form action="insert" enctype="multipart/form-data" method="post">
						...
						正文:<input type="text" name="content"><br>
				...
				<c:if test="${!empty announcement }">
					<form action="update" enctype="multipart/form-data" method="post">
						...
						标题:<input type="text" name="title" value="${announcement.title }"><br>
						正文:<input type="text" name="content" value="${announcement.content }"><br>
						图片:<input type="file" name="picture"><br>
