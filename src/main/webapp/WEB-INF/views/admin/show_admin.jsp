			...
			<div class="frame-page">
				<div class="frame-main">
					<div class="frame-main-bd">
						...
						<ul class="glb-tabs">
							<li class="glb-col-right"><a href="${basepath}/LAdmin/Admin/showAdmin?id=${sessionScope.admin.id }"
						...
						<div id="main" style="width:800px;  height:400px;">
							<div id="left" style="float:left ;  width:20%;  height:100%;">
								<form class="form-bd"
									action="${basepath}/LAdmin/Admin/toUpdateAdminPhoto?id=${sessionScope.admin.id }"
									enctype="multipart/form-data" class="glb-tables">
									<div style="padding-left: 50px;">
										<table>
											<div class="form-item">
												<h5>
													<a href="${basepath}/LAdmin/Admin/toUpdateAdminPhoto"><img
							...
							<div id="right" style="float:left ;  width:80%; height:100%;">
								<form class="form-bd" action="${basepath}/LAdmin/Admin/toUpdateAdmin">
									<table>
