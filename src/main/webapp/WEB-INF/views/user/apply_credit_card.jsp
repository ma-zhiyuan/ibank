	 ...
	 <div id="top">
		...
		<div id="page">
			<div class="main layout">
				...
				<div class="col-main">
					<div class="main-hd">
						<h3 class="iconfont icon-menu-bm">填写资料</h3>
					</div>
					<div class="main-bd">
						<div class="content-bd">
							<form class="form-bd" action="" id="demoForm">
								...
								<div class="form-item">
									<h4 class="form-label">用户密码:</h4>
									<div class="form-entity">
										<div class="form-field">
											<input class="ipt" type="text" name="userName" value="" placeholder="请输入用户密码" />
										</div>
									</div>
								</div>
								<div class="form-action clearfix">
									<a class="reset-btn" href="${basepath}/views/user/apply_credit_card.jsp">重置</a>
