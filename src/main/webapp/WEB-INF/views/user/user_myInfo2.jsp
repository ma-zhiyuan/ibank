...
<body>
	...
	<div id="page">
		<div class="main layout">
			...
			<div class="col-main">
				<div class="main-hd">
					<h3 class="iconfont icon-menu-bm">用户信息</h3>
				</div>
				<div class="main-bd">
					<div class="content-bd">
						<div class="group-hd">
							<form action="${basepath}/views/user/user_update.jsp"
								enctype="multipart/form-data">
								<table
									style="border-collapse:separate; border-spacing:0px 10px; font-size: 20px">
									<tr>
										<td>头像:</td>
										<td><img id="infoIcon" width="50px" height="50px"
											src="${basepath}/upload/user/${requestScope.user.photo }"
									...
									<tr>
										<td>生日:</td>
										<td><fmt:formatDate value="${sessionScope.user.birthday}"
												type="date" /></td>
									</tr>
									<tr>
										<td>出生地:</td>
									...
									<%-- <tr>
										<td>注册时间:</td>
										<td>${sessionScopesuser.registerDate }</td>
									</tr> --%>
									<tr>
