			...
			<div id="nav" class="glb-nav">
				<ul class="clearfix">
					...
					<li  class="glb-nav-uc current"><a
						href="${basepath}/LUser/Announcement/getAllAnnouncementByAttribute?attr=2&&pageNow=1"
	...
	<div class="content">
		<div class="main">
			...
			<div class="more2">
				<dl>
					<a
						href="${basepath}/LUser/Announcement/getAllAnnouncementByAttribute?attr=2&pageNow=1"><img
						src="${basepath}/resources/user/images/more1.jpg" /></a>
					<c:if test="${pager.hasPrePage }">
						<a
							href="${basepath}/LUser/Announcement/getAllAnnouncementByAttribute?attr=2&pageNow=
					...
					<a
						href="${basepath}/LUser/Announcement/getAllAnnouncementByAttribute?attr=2&pageNow=${requestScope.pager.totalPages}"><img
