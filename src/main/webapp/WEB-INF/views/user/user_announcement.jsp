...
<body>
	...
	<div class="content">
		<div class="main">
			...
			<div class="more2">
				<dl>
					<a href="${basepath}/LUser/Announcement/getAllAnnouncement?pageNow=1"><img
						src="${basepath}/resources/user/images/more1.jpg" /></a>
					<c:if test="${pager.hasPrePage }">
						<a
							href="${basepath}/LUser/Announcement/getAllAnnouncement?pageNow=
					...
					<a
						href="${basepath}/LUser/Announcement/getAllAnnouncement?pageNow=${requestScope.pager.totalPages}"><img
