...
<body>
	...
	<div id="page">
		<div class="main layout">
			...
			<div class="col-main">
				<div class="main-hd">
					<h3 class="iconfont icon-menu-bm">用户存款</h3>
				</div>

				<form class="form-bd" action="${basepath}/LUser/card_user/userDeposit"
					 id="form" method="post">
					<div class="form-item">
						<h4 class="form-label">请输入存款金额:</h4>
						<div class="form-entity">
							<div class="form-field">
								<input type="hidden" name="cardId"
									value="${requestScope.card.id}">
							    <input class="ipt"
									type="text" id="balance" name="balance" placeholder="请输入存款金额" />
									<span
