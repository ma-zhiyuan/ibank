							...
							<tbody>
								<c:forEach items="${requestScope.pageusers.data }" var="user">
									...
									<ul class="glb-right glb-pagination">
										<li><a href="${basepath}/LAdmin/Admin/selectAllByAgeDesc?pageNow=1">首页</a></li>&nbsp;&nbsp;&nbsp;
										<c:if test="${requestScope.pageusers.hasPrePage }">
											<li><a
												href="${basepath}/LAdmin/Admin/selectAllByAgeDesc?pageNow=${requestScope.pageusers.currentPage-1 }">上页</a>
											</li>&nbsp;&nbsp;&nbsp;
										</c:if>
										...
										<c:if test="${requestScope.pageusers.hasNextPage }">
											<li><a
												href="${basepath}/LAdmin/Admin/selectAllByAgeDesc?pageNow=${requestScope.pageusers.currentPage+1}">下页</a></li>&nbsp;&nbsp;&nbsp;
										</c:if>
										<li><a
											href="${basepath}/LAdmin/Admin/selectAllByAgeDesc?pageNow=${requestScope.pageusers.totalPages }">末页</a></li>&nbsp;&nbsp;&nbsp;
									</ul>
					</div>
				</div>
			</div>
