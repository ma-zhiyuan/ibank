...
<html>
    ...
    <body>
        ...
        <div class="glb-page glb-wrapper">
            <div class="glb-layout">
            <h1 class="glb-label">用户登录</h1>
                <div class="glb-col-p60 glb-center">
                    <form class="form-body" action="${basepath}/LCustomer/BCustomer/userloan" id="form" method="post" name="form">
                        <div class="form-item">
                            ...
                            <div class="form-entity">
                                <div class="form-field">
                                    ...
                                    <span id="error_name" style="color: #F83232">${requestScope.error1 }</span>
                                </div>
                            </div>
                        </div>
                        <div class="form-item">
